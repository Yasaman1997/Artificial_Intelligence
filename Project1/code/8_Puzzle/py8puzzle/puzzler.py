...
def main():
    ...
    print()
    "Solved with Manhattan distance exploring", count, "states"
    path, count = p.solve(h_manhattan_lsq)
    print
    "Solved with Manhattan least squares exploring", count, "states"
    path, count = p.solve(h_linear)
    print
    "Solved with linear distance exploring", count, "states"
    path, count = p.solve(h_linear_lsq)
    print
    "Solved with linear least squares exploring", count, "states"
